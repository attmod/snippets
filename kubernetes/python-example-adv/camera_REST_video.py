...
# logstream_formatter = logging.Formatter('%(asctime)s %(name)s %(levelname)s %(message)s')
# logstream.setFormatter(logstream_formatter)
# logstream.setLevel(level=logging.DEBUG)
